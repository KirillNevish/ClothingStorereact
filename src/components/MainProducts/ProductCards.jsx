...
function ProductCards() {
    ...
    let BlueTSWithLinesName = 'Blue T-Shirt with lines';
    ...
    let BlueWhiteSneakersName = 'Blue&White Sneakers';
    let BlueWhiteSneakersPrice = '20,00';
    let BlueWhiteSneakersProduct = {
        name: BlueWhiteSneakersName,
        price: BlueWhiteSneakersPrice,
        description: 'Lorem ipsum, dolor sit amet consectetur adipisicing elit. Quidem, eum. Id iusto libero est! Ullam tempora ipsa optio reiciendis veritatis harum nulla illo dolores accusamus, et ipsum, sapiente doloremque odio.',
        image: shoetwo
    };
                    ...
                    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-1">
                        ...
                        <button id={style.hideon575} class="col border border-0 bg-transparent">
                            <Link
                                ...
                                class="link-secondary link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover">
                                <div class="card shadow-sm">
                                    <img src={BlueWhiteSneakersProduct.image} height="300" alt="img" />
                                    <div class="card-body">
                        ...
                        <button id={style.hideon767} class="col border border-0 bg-transparent">
                            <Link
                                ...
                                <div class="card shadow-sm">
                                    ...
                                    <div class="card-body">
                                        <p class="card-text d-flex justify-content-between align-items-center">{BlueWhiteSneakersProduct.name}</p>
                                        <div class="d-flex justify-content-between align-items-center">
                                            <small class="text-body-secondary">{BlueWhiteSneakersProduct.price}</small>
                                        </div>
                                    </div>
                                </div>
                            </Link>
